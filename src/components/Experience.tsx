...
const experiences = [
  {
    icon: Rocket,
    year: '2025',
    title: 'AI & Vector Database Specialist',
  ...
  },
  {
    ...
    description: 'Successfully launched first major production application with 10K+ users. React Native mobile app with Firebase backend and real-time synchronization.',
